...
# crop_size = (512, 512)
# crop_size = (352, 352)
crop_size = (512, 512) #SAM


train_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(type='LoadAnnotations',reduce_zero_label=False,binary=True),#label_map={0:0,255:1}
    dict(type='SelfRandomResize',ratio_range=(0.5,1.5)),


    # dict(type='LoadNoiseprint',),
...
val_dataloader = dict(
    ...
    dataset=dict(
        type='ConcatDataset',
        datasets=[CASIAv1_plus_all_test_dataset,COVERAGE_all_test_dataset])
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        datasets=[
            ...
            Columbia_authentic_test_dataset
            ])
